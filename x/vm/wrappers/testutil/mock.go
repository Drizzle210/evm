...
//
//	mockgen -source=./x/vm/types/interfaces.go -package testutil -destination=./x/vm/wrappers/testutil/mock.go
//
...
// SpendableCoins indicates an expected call of SpendableCoins.
func (mr *MockBankWrapperMockRecorder) SpendableCoins(ctx, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
